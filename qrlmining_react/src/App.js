    ...
    return (
      <div className="App">
		...
		{/* main site content */}
		 ...
		 <div className="middle-content-section">
          <div className="simple-subscription-form ">
            <form  action="conf/email.php" method="post" enctype="text/plain">
			
              <h4 style={divStyle}><strong>Join The Mailing List</strong></h4>
              <div className="input-group-dark">
                <span className="input-group-dark-label">
                  <i className="fi-mail"></i>
                </span>
				{/* Need to fix the the input to work on ReactJS
                <input className="input-group-dark-field" 
                type="email" 
                placeholder="Email Address" 
                name="email" 
                required>
                <button className="gold round button" type="submit" >Sign Up</button>
				</input>
				*/}
              </div>
            </form>
		...
		<div className="grid-x grid-padding-x">
		  ...
		  {/* Need to learn how to call scripts correctly in ReactJS.  There is some syntax error in the var cccTheme line.
	     ...
	     <div className="mining">
          <div id="main-content-section" data-magellan-target="main-content-section">
           <div className="grid-x grid-padding-x">
			{/* Start of Timeline */}
            <div className="small-10 small-offset-1 cell">
              <div className="timeline">
                <div className="timeline-item">
                  <div className="timeline-icon">
                    <img src="" className="" height="22" width="22" alt=""></img>
                  </div>
                  <div className="timeline-content right">
                    <p className="timeline-content-date">What Is QRL Mining <span className="timeline-content-month"></span></p>
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    <p className="timeline-content-date">QRL (Quantum Resistant Ledger): <span className="timeline-content-month"></span></p>
                    <p>
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content right">
                      <p className="timeline-content-date"><span className="timeline-content-month"></span></p>
                      <p className="timeline-content-date">Why should I use a pool? <span className="timeline-content-month"></span></p>
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      <p className="timeline-content-date">Why did you make a pool? <span className="timeline-content-month"></span></p>
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content right">
                      <p className="timeline-content-date">Mining seems complicated... <span className="timeline-content-month"></span></p>
